...
1. **Télécharger les fichiers sources :**
   ...
   - [Ventes_2024.xlsx](LAB_MODULE3/Ventes_2024.xlsx) - Données de vente mensuelles  
   - [Clients_sales.csv](LAB_MODULE3/Clients_sales.csv) - Référentiel clients  
   - [Produits.json](LAB_MODULE3/Produits.json) - Catalogue produits
...
let
    ...
    #"Converti en tableau" = Table.FromList(Produits, Splitter.SplitByNothing(), null, null, ExtraValues.Error),
    #"Column1 développé" = Table.ExpandRecordColumn(#"Converti en tableau", "Column1", 
                            {"id", "nom", "categorie", "sous_categorie", "prix", "stock", "fournisseur"},
                            {"id", "nom", "categorie", "sous_categorie", "prix", "stock", "fournisseur"})
in
    #"Column1 développé"
```
...
**Scénario :** 12 fichiers Excel `Ventes_MM_2024.xlsx` à consolider. [Fichiers source disponibles ici](https://github.com/nevermind78/PBI_BI/tree/main/LAB_MODULE3/Ventes%202024)
